...
# ----------------------------
    ...
    if host and username and password:
        ...
        elif selected == "Start a container":
            container = st.text_input("Container ID/Name to start:")
            if st.button("Start"):
                st.code(run_ssh_command(host, username, password, f"docker start {container}"))
